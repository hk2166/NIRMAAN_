    ...
    <section className="py-24 relative overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mt-16 text-center transform transition-all duration-1000 delay-600 ${
          ...
          <div className="inline-block bg-gradient-to-r from-purple-600 to-pink-600 p-[2px] rounded-full">
            <button className="px-8 py-4 text-xl font-semibold text-white bg-black rounded-full hover:bg-transparent transition-colors">
