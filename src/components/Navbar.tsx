          ...
          <div className="md:hidden absolute left-0 right-0 top-full bg-black/90 backdrop-blur-lg">
            <div className="px-4 py-3 space-y-2 mobile-safe-bottom">
              ...
              <button
                ...
                className="w-full px-4 py-3 text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg hover:from-purple-500 hover:to-pink-500 transition-all duration-200 touch-active"
              >
                Register
              </button>
            </div>
